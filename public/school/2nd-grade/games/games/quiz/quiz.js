...
const questions = [
  {
    ...
    questionImage:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Flag_of_Estonia.svg/2000px-Flag_of_Estonia.svg.png',
  ...
  },
  {
    ...
    questionImage:
      'https://images.musement.com/cover/0001/64/skopjeco-jpg_header-63013.jpeg',
  ...
  },
  {
    ...
    questionImage:
      'https://www.skr.de/fileadmin/_processed_/7/4/ansicht_des_petersdoms_am_abend_6a15f044c7.jpg',
  ...
  },
  {
    ...
    questionImage:
      'https://d1dlh1v05qf6d3.cloudfront.net/information/uploads/2018/11/Diverse-team-1260x840.jpg',
  ...
  },
  {
    ...
    questionImage:
      '  https://www.belivehotels.com/imagenes/modules/hotel_mallorca_vacaciones_cala_moro_1_1600x1090.jpg',
  ...
  },
  {
    ...
    questionImage:
      ' https://www.daserste.de/information/reportage-dokumentation/erlebnis-erde/sendung/hochwasser-an-der-wolga-folge-2-100~_v-varm_444daf.jpg',
  ...
  },
  {
    ...
    questionImage:
      'https://upload.wikimedia.org/wikipedia/commons/5/53/Europa_Regionen.png',
    answers: [
      '15 Millionen Quadratkilometer',
      '20 Millionen Quadratkilometer',
      '5 Millionen Quadratkilometer',
  ...
  },
  {
    ...
    questionImage:
      'https://mbei.nrw/sites/default/files/styles/video_preview_image_big_960x540/public/assets/images/panthermedia_a12557547.jpg?itok=nnFVeEVG',
    answers: ['31', '42', '47', '58'],
    rightAnswerIndex: 2,
  },
  {
    ...
    questionImage:
      'https://img.phmuseum.com/eyJlZGl0cyI6eyJyb3RhdGUiOm51bGwsInJlc2l6ZSI6eyJ3aWR0aCI6MTYwMCwiZml0IjoiY292ZXIifX0sImJ1Y2tldCI6InYyLXBtaC1jb21tdW5pdHkiLCJrZXkiOiJ1c2Vyc1wvMzUwMDdcL2dyYW50LXN1Ym1pc3Npb25zXC8xMzc1MFwvcG03dGRvN2U5MGU1YWRiMC5qcGcifQ==',
  ...
  },
  {
    ...
    questionImage:
      'https://cdn.getyourguide.com/img/country/58de16c85136f.jpeg/88.jpg',
  ...
  },
  {
    ...
    questionImage:
      'https://g4w8c6t2.rocketcdn.me/wp-content/uploads/2018/09/Zypern-Kyrenia_1012532905.jpg',
  ...
  },
  {
    ...
    questionImage:
      'https://tubestatic.orf.at/static/images/site/tube/2021026/img_0687.5951337.jpg',
  ...
  },
  {
    questionText: 'Zu welchem Land gehört diese Flagge?',
    questionImage:
      'https://www.nationalflaggen.de/flaggen-shop/out/pictures/master/product/1/image_100000434_1.png',
  ...
  },
  {
    ...
    questionImage:
      'https://www.kafka-prag.de/fileadmin/_processed_/a/e/csm_karslbruecke_seitenansicht_870fb2eb26.jpg',
    answers: [
      'Öresund-Brücke (Ostsee, Kopenhagen)',
      'Ponte Vasco de Gama (Tejo, Lissabon)',
      'Rialtobrücke (Carnale Grande, Venedig)',
  ...
  },
  {
    ...
    questionImage:
      'https://www.ifw-kiel.de/fileadmin/_processed_/f/0/csm_20190311_EP-086075A_EVS_124_2dbf38e842.jpg',
  ...
  },
  {
    ...
    questionImage:
      'https://img.itinari.com/pages/images/original/7da8ab23-d1e0-4ebb-8bfb-55eab9dab3fe-istock-642116024.jpg?ch=DPR&dpr=1&w=1600&s=76282f8d066f8c43d2a4ababd7095c8d',
  ...
  },
  {
    ...
    questionImage:
      'https://www.steiermark.com/bildarchiv/ab_winter_2015_16/4501-4600/4542_c_steiermark_tourismus_schiffer.jpg',
    answers: [
      'Söding City',
      'Lobming',
      'St. Veit am Vogau',
...
function displayQuestion(index) {
  if (index < questions.length) {
    ...
    questionImageElement.style.backgroundImage =
      "url('https://media4.giphy.com/media/3oEjI6SIIHBdRxXI40/giphy.gif')";
...
function checkAnswer(index) {
  if (currentQuestionIndex < questions.length) {
    if (
      answerTextElements[index].innerText ===
      questions[currentQuestionIndex].answers[
        questions[currentQuestionIndex].rightAnswerIndex
      ]
    ) {
